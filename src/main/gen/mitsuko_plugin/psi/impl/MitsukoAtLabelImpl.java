...
public class MitsukoAtLabelImpl extends ASTWrapperPsiElement implements MitsukoAtLabel {

  public MitsukoAtLabelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MitsukoVisitor visitor) {
    visitor.visitAtLabel(this);
  }
