...
public class MitsukoFlowImpl extends ASTWrapperPsiElement implements MitsukoFlow {

  public MitsukoFlowImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MitsukoCondition> getConditionList() {
