...
public class MitsukoFnDefineImpl extends ASTWrapperPsiElement implements MitsukoFnDefine {

  public MitsukoFnDefineImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MitsukoVisitor visitor) {
    visitor.visitFnDefine(this);
  }
