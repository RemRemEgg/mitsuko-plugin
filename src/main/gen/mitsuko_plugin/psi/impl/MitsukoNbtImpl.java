...
public class MitsukoNbtImpl extends ASTWrapperPsiElement implements MitsukoNbt {

  public MitsukoNbtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MitsukoNbtInternal> getNbtInternalList() {
