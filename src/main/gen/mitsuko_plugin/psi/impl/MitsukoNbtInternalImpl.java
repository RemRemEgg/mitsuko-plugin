...
public class MitsukoNbtInternalImpl extends ASTWrapperPsiElement implements MitsukoNbtInternal {

  public MitsukoNbtInternalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MitsukoVisitor visitor) {
    visitor.visitNbtInternal(this);
  }
  ...
  @Override
  @Nullable
  public MitsukoNbtInternal getNbtInternal() {
    return findChildByClass(MitsukoNbtInternal.class);
  }
