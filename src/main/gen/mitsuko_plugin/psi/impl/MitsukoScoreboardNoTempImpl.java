...
public class MitsukoScoreboardNoTempImpl extends ASTWrapperPsiElement implements MitsukoScoreboardNoTemp {

  public MitsukoScoreboardNoTempImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MitsukoVisitor visitor) {
    visitor.visitScoreboardNoTemp(this);
  }
